    ...
    <div class="container lg:w-1/2 md:w-4/5 w-11/12 mx-auto mt-8 px-8 bg-white shadow-md">
        ...
        <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <input type="string" name="kid_name"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="お子さんの名前" value="{{ old('kid_name') }}">
            </div>
            <div class="mb-4">
                ...
                <input type="string" name="category"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="カテゴリ" value="{{ old('category') }}">
            </div>
            <div class="mb-4">
                ...
                <input type="string" name="title"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="項目名" value="{{ old('title') }}">
            </div>
            <div class="mb-4">
                ...
                <input type="char" name="evaluation"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="評価" value="{{ old('evaluation') }}">
            </div>
            <div class="mb-4">
                ...
                <input type="string" name="teacher"
                    class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full py-2 px-3"
                    required placeholder="担当" value="{{ old('teacher') }}">
            </div>
